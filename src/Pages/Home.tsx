      ...
      <main id="main">
        <Wrapper>
          ...
          <section className={styles.collectionSection}>
            <h1 className={styles.collectionTitle}>our collection</h1>
            <div className={styles.collectionItem}>
              ...
              />
              <h2 className={styles.collectionItemTitle}>Gran Espresso</h2>
              <p>
            ...
            <div className={styles.collectionItem}>
              <img
                ...
                className={styles.collectionImage}
              />
              <h2 className={styles.collectionItemTitle}>Planalto</h2>
              <p>
            ...
            <div className={styles.collectionItem}>
              <img
                ...
                className={styles.collectionImage}
              />
              <h2 className={styles.collectionItemTitle}>Piccollo</h2>
              <p>
            ...
            <div className={styles.collectionItem}>
              <img
                ...
                className={styles.collectionImage}
              />
              <h2 className={styles.collectionItemTitle}>Danche</h2>
              <p>
